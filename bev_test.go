...
func TestEchoTiny(t *testing.T) {
	...
	setupEchoParallelClient(l, 100, [2]int{1, 2}, 100, true, 0)
	closeEchoServer(eb, l)
}

func TestEchoHuge(t *testing.T) {
	eb, l := setupEchoServer(1024*1024*10, 1024*1024*10, 1024*1024*20)
	setupEchoParallelClient(l, 100, [2]int{1024 * 1024, 1024 * 1024 * 10}, 1024*1024*300, true, 0)
	closeEchoServer(eb, l)
}

func TestEchoMedium(t *testing.T) {
	eb, l := setupEchoServer(1024*512, 1024*16, 1024*512)
	setupEchoParallelClient(l, 100, [2]int{4, 1024 * 16}, 1024*1024*100, true, 0)
	closeEchoServer(eb, l)
}
